    ...
    fetch('livres.json')
        ...
        .then(data => {
            ...
            Object.keys(data).forEach(livre => {
                ...
                a.href = `details.html?nom=${encodeURIComponent(data[livre].nom_oeuvre)}&description=${encodeURIComponent(data[livre].description)}&URL=${encodeURIComponent(data[livre].URL)}`;
                li.appendChild(a);
